...
# # 1. Sửa định nghĩa hàm: Cho phép float và mặc định là 0
#     def insert_trades_batch(self, trades: List[GetC2CTradeHistoryResponseDataInner], sleep_interval: float = 0):
#         """
#         Insert multiple trade records into database
        
#         Args:
#             trades: List of trade records
#             sleep_interval: Time to wait between inserts in seconds (default: 0)
#         """
...
#                     # 2. Sửa logic kiểm tra và thêm dấu hai chấm (:)
#                     if sleep_interval > 0:
...
#             sleep_env = os.getenv("SLEEP_INTERVAL", "0")
#             try:
#                 sleep_interval = float(sleep_env)
#             except ValueError:
#                 logger.warning(f"⚠️ Invalid SLEEP_INTERVAL '{sleep_env}', defaulting to 0")
#                 sleep_interval = 0
#             # Fetch data from API
