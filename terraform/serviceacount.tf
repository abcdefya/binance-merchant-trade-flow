# ---------------------------Google Cloud Service Account for Airflow GCS Logger
resource "google_service_account" "airflow_gcs_logger" {
  project      = var.project_id
  account_id   = "airflow-gcs-logger"
  display_name = "Airflow GCS Logger Service Account"
  description  = "Service account for Airflow to write logs to GCS bucket"
}
